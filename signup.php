...
<?php
  ...
  if (isset($_POST['registration'])) {
    ...
    $profilepics    ='profilepics/'.$profilepic;
     ...
     $query ="INSERT INTO students(name,contactno,emailid,password,address,created_date,profilepic) VALUES('$fullname','$contactno','$emailid','$password','$address','$created_date','$profilepic')";
